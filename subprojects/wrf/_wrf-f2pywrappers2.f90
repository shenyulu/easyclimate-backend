...
!     It contains Fortran 90 wrappers to fortran functions.
      ...
      subroutine f2pyinitomp_constants(f2pysetupfunc)
      use omp_constants, only : fomp_sched_kind
      use omp_constants, only : fomp_lock_kind
      use omp_constants, only : fomp_nest_lock_kind
      use omp_constants, only : fomp_sched_static
      use omp_constants, only : fomp_sched_dynamic
      use omp_constants, only : fomp_sched_guided
      use omp_constants, only : fomp_sched_auto
      external f2pysetupfunc
      call f2pysetupfunc(fomp_sched_kind,fomp_lock_kind,fomp_nest_lock_k&
     &ind,fomp_sched_static,fomp_sched_dynamic,fomp_sched_guided,fomp_sc&
     &hed_auto)
      end subroutine f2pyinitomp_constants
