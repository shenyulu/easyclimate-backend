...
c      INTEGER NLEV,LINLOG,IER
c      DOUBLE PRECISION P(NLEV),X(NLEV),PSFC,XSFC,PBOT,PTOP,PLVCRT,XMSG,
c     +                 VINT
      INTEGER, INTENT(IN) :: NLEV, LINLOG
      INTEGER, INTENT(OUT) :: IER
      DOUBLE PRECISION, INTENT(IN) :: P(NLEV), X(NLEV)
      DOUBLE PRECISION, INTENT(IN) :: XMSG, PSFC, XSFC, PBOT, PTOP,
     +                   PLVCRT
      DOUBLE PRECISION, INTENT(OUT) :: VINT
