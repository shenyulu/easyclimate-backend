...
docker exec my_container source /root/venv_py313/bin/activate && cd ${repository_path} && source /opt/intel/oneapi/setvars.sh --force && bash ./build_wheel_manylinux.sh && cd /root

docker exec my_container /root/venv_py312/bin/python -m pip install -r ${repository_python_build_requirement}
docker exec my_container source /root/venv_py312/bin/activate && cd ${repository_path} && source /opt/intel/oneapi/setvars.sh --force && bash ./build_wheel_manylinux.sh && cd /root

docker exec my_container /root/venv_py311/bin/python -m pip install -r ${repository_python_build_requirement}
docker exec my_container source /root/venv_py311/bin/activate && cd ${repository_path} && source /opt/intel/oneapi/setvars.sh --force && bash ./build_wheel_manylinux.sh && cd /root

docker exec my_container /root/venv_py310/bin/python -m pip install -r ${repository_python_build_requirement}
docker exec my_container source /root/venv_py310/bin/activate && cd ${repository_path} && source /opt/intel/oneapi/setvars.sh --force && bash ./build_wheel_manylinux.sh && cd /root
